...
load("../../data/rf/featureNames_20180411")
LCMAPdt_train=get(load('../../data/rf/clusters/tc_20180411_k50_dt'))
}

if(rfid == "tc_20180415_noBC_k55_pam_rf"){

load("../../data/rf/featureNames_20180415")
LCMAPdt_train=get(load('../../data/rf/clusters/tc_20180416_noBC_k55_dt'))
}
...
LCMAPdt_train=get(load('../../data/rf/clusters/tc_20180416_noGeoNoBC_k55_dt'))
}
...
predictLCMAP = function(i, ti){
  ...
  # featureAssignment based on rfid
  if("eco_TaigaPlain" %in% featureNames){
